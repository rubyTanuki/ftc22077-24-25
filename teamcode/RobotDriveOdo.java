...
public class RobotDriveOdo implements Odometry{
    ...
    public void updateTracking(){
        ...
        int deltaFL = bot.getFLPos() - bot.lfTicksPrev;
        int deltaFR = bot.getFRPos() - bot.rfTicksPrev;
        int deltaBL = bot.getBLPos() - bot.lbTicksPrev;
        int deltaBR = bot.getBRPos() - bot.rbTicksPrev;
        ...
        bot.setLfTicksPrev(bot.getFLPos());
        bot.setRfTicksPrev(bot.getFRPos());
        bot.setLbTicksPrev(bot.getBLPos());
        bot.setRbTicksPrev(bot.getBRPos());
    }
